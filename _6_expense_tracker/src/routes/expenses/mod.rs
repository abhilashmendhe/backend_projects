use actix_web::{
    middleware::from_fn,
    web::{self, ServiceConfig, route, scope},
};

use crate::{
    middleware::require_auth::require_auth,
    routes::expenses::{
        create_expense::create_expense, delete_expense::delete_expense,
        get_all_expenses::get_all_expenses, get_expense_by_id::get_expense_by_id,
