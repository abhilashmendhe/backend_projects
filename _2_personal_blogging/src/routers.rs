...
use crate::{middleware::require_auth::require_authentication, routes::{comments::{create_comment::create_comment, delete_comment::delete_comment, fetch_comments::fetch_comments, update_comment::update_comment}, posts::{create_post::create_post, delete_post::delete_post, get_posts::{fetch_all_posts, fetch_post_by_id}, update_post::update_post}, users::{create_user::create_user, delete_user::delete_user, login::login, logout::logout, update_password::update_user_password}}, utils::app_state::AppState};
...
pub fn create_router(app_state: AppState) -> Router {
    ...
    Router::new()
        ...
        .route("/v1/posts/{:post_id}/comments", get(fetch_comments)
            .route_layer(middleware::from_fn_with_state(app_state.clone(), require_authentication)))
